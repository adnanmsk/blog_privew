...
flowchart TD
    ...
    S -- "<span style='background:transparent !important; border:1.5px solid #3b82f6 !important; color:#3b82f6 !important; padding:2px 6px; border-radius:4px; font-size:10px; font-weight:bold; display:inline-block;'>Stable Frames</span>" --> Seg["Bat Mask<br><i>Object Tracking</i>"]:::infer
    ...
    K -- "<span style='background:transparent !important; border:1.5px solid #f59e0b !important; color:#f59e0b !important; padding:2px 6px; border-radius:4px; font-size:10px; font-weight:bold; display:inline-block;'>Raw 3D Points</span>" --> F["3D Fusion<br><i>Physics-based Smoothing</i>"]:::phys
    
    F -- "<span style='background:transparent !important; border:1.5px solid #ef4444 !important; color:#ef4444 !important; padding:2px 6px; border-radius:4px; font-size:10px; font-weight:bold; display:inline-block;'>Smooth Trajectory</span>" --> R["Render Bat Swing Plane<br><i>3D Visualization</i>"]:::out
...
flowchart TD
    ...
    S -- "<span style='background:transparent !important; border:1.5px solid #e94560 !important; color:#e94560 !important; padding:2px 6px; border-radius:4px; font-size:10px; font-weight:bold; display:inline-block;'>Stable Frames</span>" --> Seg["Bat Mask<br><i>Object Tracking</i>"]:::infer
    ...
    K -- "<span style='background:transparent !important; border:1.5px solid #f9a826 !important; color:#f9a826 !important; padding:2px 6px; border-radius:4px; font-size:10px; font-weight:bold; display:inline-block;'>Raw 3D Points</span>" --> F["3D Fusion<br><i>Physics-based Smoothing</i>"]:::phys
    F -- "<span style='background:transparent !important; border:1.5px solid #43d8c9 !important; color:#43d8c9 !important; padding:2px 6px; border-radius:4px; font-size:10px; font-weight:bold; display:inline-block;'>Smooth Trajectory</span>" --> R["Render Bat Swing Plane<br><i>3D Visualization</i>"]:::out
...
flowchart TD
    ...
    S -- "<span style='background:transparent !important; border:1.5px solid #606c38 !important; color:#606c38 !important; padding:2px 6px; border-radius:4px; font-size:10px; font-weight:bold; display:inline-block;'>Stable Frames</span>" --> Seg["Bat Mask<br><i>Object Tracking</i>"]:::infer
    ...
    K -- "<span style='background:transparent !important; border:1.5px solid #bc6c25 !important; color:#bc6c25 !important; padding:2px 6px; border-radius:4px; font-size:10px; font-weight:bold; display:inline-block;'>Raw 3D Points</span>" --> F["3D Fusion<br><i>Physics-based Smoothing</i>"]:::phys
    F -- "<span style='background:transparent !important; border:1.5px solid #006d77 !important; color:#006d77 !important; padding:2px 6px; border-radius:4px; font-size:10px; font-weight:bold; display:inline-block;'>Smooth Trajectory</span>" --> R["Render Bat Swing Plane<br><i>3D Visualization</i>"]:::out
...
flowchart TD
    ...
    S -- "<span style='background:transparent !important; border:1.5px solid #ffafcc !important; color:#ffafcc !important; padding:2px 6px; border-radius:4px; font-size:10px; font-weight:bold; display:inline-block;'>Stable Frames</span>" --> Seg["Bat Mask<br><i>Object Tracking</i>"]:::infer
    ...
    K -- "<span style='background:transparent !important; border:1.5px solid #b492c7 !important; color:#b492c7 !important; padding:2px 6px; border-radius:4px; font-size:10px; font-weight:bold; display:inline-block;'>Raw 3D Points</span>" --> F["3D Fusion<br><i>Physics-based Smoothing</i>"]:::phys
    F -- "<span style='background:transparent !important; border:1.5px solid #ffd6a5 !important; color:#ffd6a5 !important; padding:2px 6px; border-radius:4px; font-size:10px; font-weight:bold; display:inline-block;'>Smooth Trajectory</span>" --> R["Render Bat Swing Plane<br><i>3D Visualization</i>"]:::out
...
flowchart TD
    ...
    S -- "<span style='background:transparent !important; border:1.5px solid #000000 !important; color:#000000 !important; padding:2px 6px; border-radius:4px; font-size:10px; font-weight:bold; display:inline-block;'>Stable Frames</span>" --> Seg["Bat Mask<br><i>Object Tracking</i>"]:::infer
    ...
    K -- "<span style='background:transparent !important; border:1.5px solid #666666 !important; color:#666666 !important; padding:2px 6px; border-radius:4px; font-size:10px; font-weight:bold; display:inline-block;'>Raw 3D Points</span>" --> F["3D Fusion<br><i>Physics-based Smoothing</i>"]:::phys
    F -- "<span style='background:transparent !important; border:1.5px solid #000000 !important; color:#000000 !important; padding:2px 6px; border-radius:4px; font-size:10px; font-weight:bold; display:inline-block;'>Smooth Trajectory</span>" --> R["Render Bat Swing Plane<br><i>3D Visualization</i>"]:::out
...
flowchart TD
    ...
    S -- "<span style='background:transparent !important; border:1.5px solid #00acc1 !important; color:#00acc1 !important; padding:2px 6px; border-radius:4px; font-size:10px; font-weight:bold; display:inline-block;'>Stable Frames</span>" --> Seg["Bat Mask<br><i>Object Tracking</i>"]:::infer
    ...
    K -- "<span style='background:transparent !important; border:1.5px solid #8e24aa !important; color:#8e24aa !important; padding:2px 6px; border-radius:4px; font-size:10px; font-weight:bold; display:inline-block;'>Raw 3D Points</span>" --> F["3D Fusion<br><i>Physics-based Smoothing</i>"]:::phys
    F -- "<span style='background:transparent !important; border:1.5px solid #3949ab !important; color:#3949ab !important; padding:2px 6px; border-radius:4px; font-size:10px; font-weight:bold; display:inline-block;'>Smooth Trajectory</span>" --> R["Render Bat Swing Plane<br><i>3D Visualization</i>"]:::out
...
flowchart TD
    ...
    S -- "<span style='background:transparent !important; border:1.5px solid #f3c5b5 !important; color:#f3c5b5 !important; padding:2px 6px; border-radius:4px; font-size:10px; font-weight:bold; display:inline-block;'>Stable Frames</span>" --> Seg["Bat Mask<br><i>Object Tracking</i>"]:::infer
    ...
    K -- "<span style='background:transparent !important; border:1.5px solid #c25437 !important; color:#c25437 !important; padding:2px 6px; border-radius:4px; font-size:10px; font-weight:bold; display:inline-block;'>Raw 3D Points</span>" --> F["3D Fusion<br><i>Physics-based Smoothing</i>"]:::phys
    F -- "<span style='background:transparent !important; border:1.5px solid #8c3420 !important; color:#8c3420 !important; padding:2px 6px; border-radius:4px; font-size:10px; font-weight:bold; display:inline-block;'>Smooth Trajectory</span>" --> R["Render Bat Swing Plane<br><i>3D Visualization</i>"]:::out
...
flowchart TD
    ...
    S -- "<span style='background:transparent !important; border:1.5px solid #0077b6 !important; color:#0077b6 !important; padding:2px 6px; border-radius:4px; font-size:10px; font-weight:bold; display:inline-block;'>Stable Frames</span>" --> Seg["Bat Mask<br><i>Object Tracking</i>"]:::infer
    ...
    K -- "<span style='background:transparent !important; border:1.5px solid #90e0ef !important; color:#90e0ef !important; padding:2px 6px; border-radius:4px; font-size:10px; font-weight:bold; display:inline-block;'>Raw 3D Points</span>" --> F["3D Fusion<br><i>Physics-based Smoothing</i>"]:::phys
    F -- "<span style='background:transparent !important; border:1.5px solid #ffffff !important; color:#ffffff !important; padding:2px 6px; border-radius:4px; font-size:10px; font-weight:bold; display:inline-block;'>Smooth Trajectory</span>" --> R["Render Bat Swing Plane<br><i>3D Visualization</i>"]:::out
